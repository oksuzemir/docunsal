...
add_action('init', function () {
    ...
    //header
    //anasayfa-second-content
    pll_register_string('mytheme-hello', 'Randevu Al');
    pll_register_string('mytheme-hello', '056132724');
    pll_register_string('mytheme-hello', 'İletişim');
    pll_register_string('mytheme-hello', '/iletisim');
    //anasayfa-third-content
    pll_register_string('mytheme-hello', 'Detaylar');
    pll_register_string('mytheme-hello', '/hakimda');
    //anasayfa-fourth-content
    pll_register_string('mytheme-hello', 'Her Hastaya Özel Kişisel Yaklaşım');
    //anasayfa-fifth-content
    pll_register_string('mytheme-hello', 'Hepsi');
    pll_register_string('mytheme-hello', '/tedaviler');
    //anasayfa-blog
    pll_register_string('mytheme-hello', 'İncele');
    pll_register_string('mytheme-hello', '/blog');
    //footer
    pll_register_string('mytheme-hello', 'Teşvikiye Mahallesi Valikonağı Caddesi, Fulya Sk. No: 2A, 34000 Şişli/İstanbul');
    pll_register_string('mytheme-hello', 'Site Haritası');
    pll_register_string('mytheme-hello', 'Google Harita');
    pll_register_string('mytheme-hello', 'Tüm Hakları Saklıdır.');
    pll_register_string('mytheme-hello', '/kvkk-ve-aydinlatma-metni');
    pll_register_string('mytheme-hello', 'KVKK ve Aydınlatma Metni');
    //widget card
    pll_register_string('mytheme-hello', 'Devamını Oku');
});
...
class Custom_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        <a href="<?php echo esc_url($instance['link']); ?>">
            <div loading="lazy" class="third-content-card lazy">
                <div class="third-content-ikon">
                    <img class="lazy" lodaing="lazy" src="<?php echo esc_url($instance['image_uri']); ?>" />
                </div>
                <h2 class="third-content-title">
                    <?php
                ...
                <?php }
                    ...
                    <p class="harf-siniri"><?php echo nl2br(esc_html($instance['text'])) ?></p>
                </div>
                <div class="devamini-oku"><span><?php pll_e('Devamını Oku'); ?></span> </div>
            </div>
        </a>
    <?php }
...
?><li><?php
        ...
        <div class="flexslider-content">
            <div class="flexslider-konten">
                <div class="flexslider-inner">
                    <div class="flexslider-title1">
                        <?php
                        if (!empty($instance['title'])) { ?>
                            <?php echo nl2br(esc_html($instance['title'])) ?>
                    </div>
                    <div class="flexslider-title2">
                    <?php }
        ...
        </div> <img src="<?php echo esc_url($instance['image_uri']); ?>" />
    <?php }
                        if (!empty($instance['link'])) { ?>
...
\*------------------------------------*/
            ...
            if (function_exists('register_sidebar')) {
                register_sidebar(array(
                    'name' => __('Anasayfa Uzmanlıklar', 'html5blank'),
                ...
                register_sidebar(array(
                    'name' => __('Anasayfa Tedaviler', 'html5blank'),
                    'description' => __('Anasayfa Card Yapısı', 'html5blank'),
                    'id' => 'parallax-cumle',
                    'before_widget' => '<div id="%1$s">',
                    'after_widget' => '</div>'
                ...
                register_sidebar(array(
                    'name' => __('Anasayfa Banner', 'html5blank'),
